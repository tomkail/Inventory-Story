...
public class RoundedPropertiesDrawer : PropertyDrawer
{
	...
	public override void OnGUI (Rect position, SerializedProperty property, GUIContent label)
	{
		...
		showRadiusSettings = EditorGUI.Foldout(propertyPosition, showRadiusSettings, new GUIContent("Radius"), true);
		...
		propertyPosition.y += EditorGUIUtility.singleLineHeight;
		showResolutionSettings = EditorGUI.Foldout(propertyPosition, showResolutionSettings, new GUIContent("Resolution"), true);
		propertyPosition.y += EditorGUIUtility.singleLineHeight;
