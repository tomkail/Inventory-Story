...
public class MenuItems
{
	...
	{
		Undo.AddComponent<ThisOtherThing.UI.Shapes.Line>(CreateShapeGO("Line", menuCommand));
	}

	[MenuItem("GameObject/UI/Shapes/Polygon", false, 30)]
	public static void AddPolygon(MenuCommand menuCommand)
	{
		Undo.AddComponent<ThisOtherThing.UI.Shapes.Polygon>(CreateShapeGO("Polygon", menuCommand));
	}
